				...
				<div id="content">
					<div class="post">
						...
						<div class="entry">
							...
							<%
							int inum = Integer.parseInt(request.getParameter("inum")) - 2;
							...
							try {
							    ...
							    if(rs.next()) {
							    	num = rs.getInt(53);
							    	lastIngredient = rs.getString(num + 2);
							    }
								String update = "UPDATE Account SET i" + inum + "=\'" + lastIngredient + "\' WHERE username=\'" + username + "\'";
							    statement.executeUpdate(update);
							    update = "UPDATE Account SET i" + num + "=NULL WHERE username=\'" + username + "\'";
							    statement.executeUpdate(update);
							    update = "UPDATE Account SET numOfIngredients=numOfIngredients-1 WHERE username=\'" + username + "\'";
							    statement.executeUpdate(update);
							} catch (Exception e) {
