					...
					<div class="post">
						...
						<div class="entry">
							...
							try {
							    ...
							    if(rs.next()) {
							    	int num = rs.getInt(53) + 1;
							    	if(num <= 50) {
								    	String update = "UPDATE Account SET i" + num + "=\'" + ingredient + "\' WHERE username=\'" + username + "\'";
									    statement.executeUpdate(update);
									    update = "UPDATE Account SET numOfIngredients=numOfIngredients+1 WHERE username=\'" + username + "\'";
									    statement.executeUpdate(update);
									    %><h2 class="title"><a href="#">Ingredient Added to Pantry!</a></h2><%
							    	}
								    else {
								    	%><h2 class="title"><a href="#">No More Space for More Ingredients!</a></h2><%
								    }
							    }
							    else {
							    	%><h2 class="title"><a href="#">No More Space for More Ingredients!</a></h2><%
